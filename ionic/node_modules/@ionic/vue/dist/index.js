...
const IonPage = /*@__PURE__*/ vue.defineComponent({
    ...
    setup(props, { attrs, slots }) {
        ...
        return () => {
            var _a;
            const existingClasses = (_a = attrs.class) !== null && _a !== void 0 ? _a : '';
            return vue.h('div', Object.assign(Object.assign({}, attrs), { ['class']: `ion-page ${hidePageClass} ${existingClasses}`, ref: 'ionPage' }), slots.default && slots.default());
        };
    }
});
