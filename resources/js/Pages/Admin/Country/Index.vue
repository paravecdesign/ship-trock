              ...
              <div class="rounded-md border mr-5">
                ...
                <div class="border">
                  <form @submit.prevent="submit">
                    <div class="mt-4 p-3">
                      <BreezeLabel for="name" value="Country" />
                      <input
                    ...
                    <div class="mt-4 p-3">
                      <BreezeLabel for="sortname" value="Sort Name" />
                      <input
                        class="block w-full mt-1 text-xs"
                        type="text"
                    ...
                    <div class="mt-4 p-3">
                      <BreezeLabel for="phonecode" value="Phone Code" />
                      <input
                        class="block w-full mt-1 text-xs"
                        type="text"
                ...
                <table class="w-full whitespace-no-wrap">
                  <thead>
                    <tr
                      ...
                      "
                    >
                      <th class="px-4 py-3">Country ID</th>
                      <th class="px-4 py-3">name</th>
                      <th class="px-4 py-3">Sort Name</th>
                      <th class="px-4 py-3">Phone Code</th>
                  ...
                  <tbody class="bg-white divide-y">
                    ...
                    >
                      ...
                      <td class="px-3 py-2">{{ country.name }}</td>
                      <td class="px-3 py-2">{{ country.sortname }}</td>
                      <td class="px-3 py-2">{{ country.phonecode }}</td>
...
export default {
  ...
  methods: {
    ...
    submit() {
      this.form.post(route("admin.setting.countries.store"), {
        onSuccess: () => this.form.reset(),
      });
    },
     destroy(id) {
