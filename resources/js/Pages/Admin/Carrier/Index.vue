...
export default {
  ...
  methods: {
    ...
    submit() {
      this.form.post(route("admin.setting.carriers.store"), {
        onSuccess: () => this.form.reset(),
      });
    },
    destroy(id) {
      if (confirm("Are you sure?")) {
        Inertia.delete(route("admin.setting.carriers.destroy", id));
      }
    },
  },
};
