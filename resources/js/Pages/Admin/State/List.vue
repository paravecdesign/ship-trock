            ...
            >
                ...
                <div class="space-y-8 pt-10 col-span-5">
                       <div class="justify-end flex pr-5">
                        <Link
                             :href="'/admin/setting/states/' + state.country_id"
                    ...
                    <div class="grid grid-cols-3">
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="flex justify-end pr-4 pt-4"></div>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        submit() {
            this.form.post(route("admin.setting.cities.store"), {
                onSuccess: () => this.form.reset(),
            });
        },
        destroy(id) {
