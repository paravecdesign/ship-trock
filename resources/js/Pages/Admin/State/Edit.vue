            ...
            >
                ...
                <div class="space-y-8 pt-10 col-span-5">
                    <div class="justify-end flex pr-5">
                        <Link
                            :href="route('admin.setting.states.index')"
...
export default {
    ...
    methods: {
        ...
        submit() {
            this.form.put(
                route("admin.setting.states.update", this.state.id),
                {
                    onSuccess: () => this.form.reset(),
                }
            );
        ...
        destroy(id) {
            this.$inertia.delete(route("admin.setting.states.destroy", id));
        },
    },
};
</script>
