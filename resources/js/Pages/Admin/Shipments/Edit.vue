                ...
                <div class="flex justify-between mx-3 px-4 py-2 w-full">
                    ...
                    <div class="inline-flex text-sm text-gray-600">
                        <div>
                                         <BreezeButton
                        class="block w-full"
                        :class="{ 'odivacity-25': form.processing }"
                ...
                <div class="grid grid-cols-8 gap-2">
                    ...
                    <div class="col-span-3 mt-4">
                        <label>Customers List</label>
                         <Select2 v-model="form.customer_id" :options="customers" :settings="{ width: '100%', height: '120px'}" />
...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            status_id: props.shipment.status_id,
            shipper_id: props.shipment.shipper_id,
            customer_id: props.shipment.customer_id,
            ...
            freight: props.shipment.freight,
            volume: props.shipment.volume,
        });
