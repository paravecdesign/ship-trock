          ...
          <div class="grid grid-cols-3">
            <div class="col-span-1">
              <div class="rounded-md border mr-5">
                <h3 class="text-gray-600 p-3">Status</h3>
                <div class="border">
                  <form @submit.prevent="submit">
                    ...
                    <div class="mt-4 p-3">
                      <BreezeLabel for="percentage" value="Percentage" />
                      <input
                        class="block w-full mt-1 text-xs"
                        type="text"
                ...
                <table class="w-full whitespace-no-wrap">
                  ...
                  <tbody class="bg-white divide-y">
                    <tr
                      ...
                      class="text-gray-700"
                    >
                      <td class="px-3 py-2">{{ status.id }}</td>
                      <td class="px-3 py-2">{{ status.name }}</td>
                      <td class="px-3 py-2">{{ status.percentage }}</td>
...
export default {
  ...
  methods: {
    edit(id) {
      this.$inertia.get(route("admin.setting.statuses.edit", id), {
        onSuccess: () => this.form.reset(),
      });
    },
    submit() {
      this.form.post(route("admin.setting.statuses.store"), {
        onSuccess: () => this.form.reset(),
      });
    },
       destroy(id) {
      this.$inertia.delete(route("admin.setting.statuses.destroy", id));
    },
  },
