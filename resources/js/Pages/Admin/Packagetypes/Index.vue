                    ...
                    <div class="grid grid-cols-3">
                        <div class="col-span-1">
                            <div class="rounded-md border mr-5">
                                <h3 class="text-gray-600 p-3">Package Type</h3>
                                <div class="border">
                        ...
                        <div class="col-span-2">
                            <div class="rounded-md border mr-5">
                                <table class="w-full whitespace-no-wrap">
                                    ...
                                    <tbody class="bg-white divide-y">
                                        <tr
                                            v-for="packagetype in packagetypes.data"
                                            :key="packagetype.id"
                                            class="text-gray-700"
                                        >
                                            <td class="px-3 py-2">
                            ...
                            <div class="flex justify-end pr-4 pt-4">
                                <pagination :links="packagetypes.links" />
                            </div>
                        </div>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        edit(id) {
            this.$inertia.get(route("admin.setting.packagetypes.edit", id), {
                onSuccess: () => this.form.reset(),
            });
        },
        submit() {
            this.form.post(route("admin.setting.packagetypes.store"), {
                onSuccess: () => this.form.reset(),
            });
        },
        destroy(id) {
            if (confirm("Are you sure?")) {
                Inertia.delete(route("admin.setting.packagetypes.destroy", id));
            }
        },
    },
};
