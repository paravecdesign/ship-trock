            ...
            >
                ...
                <div class="space-y-8 pt-10 col-span-5">
                    <div class="justify-end flex pr-5">
                        <Link
                            :href="route('admin.setting.shippers.index')"
                    ...
                    <div class="grid grid-cols-3">
                        <div class="col-span-1">
                            <div class="rounded-md border mr-5">
                                <h3 class="text-gray-600 p-3">Shipper</h3>
                                <div class="border">
                            ...
                            <div class="rounded-md border mr-5">
                                <table class="w-full whitespace-no-wrap">
                                    ...
                                    <tbody class="bg-white divide-y">
                                        <tr
                                            v-for="shipper in shippers.data"
                                            :key="shipper.id"
                                            class="text-gray-700"
                                        >
                                            <td class="px-3 py-2">
...
export default {
    ...
    methods: {
        edit(id) {
            this.$inertia.get(route("admin.setting.shippers.edit", id), {
                onSuccess: () => this.form.reset(),
            });
        },
        submit() {
            this.form.put(
                route("admin.setting.shippers.update", this.shipper.id),
                {
                    onSuccess: () => this.form.reset(),
                }
            );
        ...
        destroy(id) {
            this.$inertia.delete(route("admin.setting.shippers.destroy", id));
        },
    },
};
</script>
