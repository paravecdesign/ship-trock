...
// dd($query->paginate(15));
        ...
        return Inertia::render('Customers/Packages/Index', [
            'shipments' => $query->paginate(15)->through(function ($shipment) {
                return [
                    ...
                    'rate_weight' => $shipment->rate->weight ?? '',
    ...
    public function create()
    {
        ...
        return Inertia::render('Customers/Packages/Create', [
    ...
    {
        $package = Shipments::with('packagetype','shipstatus')->find($id);
        // dd($package);
        return Inertia::render('Customers/Packages/Detail', [
            'shipment' => new ShipmentResource($package)
        ]);
    }
    ...
    {
        return Inertia::render('Customers/Packages/Edit', [
            'shipment' => new ShipmentResource(Shipments::find($id)) ,
            'customers' => $this->users,
            'rates' => $this->rates,
            'shippers' => $this->shippers,
            'carriers' => $this->carriers,
